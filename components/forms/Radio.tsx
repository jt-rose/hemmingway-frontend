      ...
      {props.radioOptions.map((ro, index) => (
        <div className="flex items-center mb-4">
          <input
            ...
            name={props.name}
            value={ro}
            className="w-4 h-4 border-gray-300 appearance-none checked:bg-teal-500 rounded-xl border-2 checked:border-teal-600 dark:accent-teal-700 dark:focus:bg-teal-600 dark:bg-gray-700 dark:border-gray-600"
